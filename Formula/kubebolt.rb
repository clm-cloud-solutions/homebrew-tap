...
#   3. Replaces 2.0.1 / __SHA_*__ placeholders
...
class Kubebolt < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "8c1634dc3ee594e241d9cb7408b3da6eecd9fc115bd0ef82111dcf56143aa9a3"
    end
    on_intel do
      url "https://github.com/clm-cloud-solutions/kubebolt/releases/download/v#{version}/kubebolt-darwin-amd64"
      sha256 "d72041a31449d8dd8ad8e367351efbd8e95934d5ec11d7b2d4b11122ec6ceca4"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "eec9a01270e189596c937513c23a150479fb8bf871a7d6189e0fe113f99ffab1"
    end
    on_intel do
      url "https://github.com/clm-cloud-solutions/kubebolt/releases/download/v#{version}/kubebolt-linux-amd64"
      sha256 "3cc77115d0a7306fd6ee44ce66ecb352db9e31068cd8542ec4ea32d06fc62400"
    end
  end
