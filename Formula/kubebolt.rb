...
#   3. Replaces 2.0.2 / __SHA_*__ placeholders
...
class Kubebolt < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "bae6ff8c8c690cad7bc8970a054c4e4d48a5e752d9ef7b8ead063fb18c5e4773"
    end
    on_intel do
      url "https://github.com/clm-cloud-solutions/kubebolt/releases/download/v#{version}/kubebolt-darwin-amd64"
      sha256 "d4b089fcf576783e88b0720bba3553bb7facb9dd91dbd3f4279b3e44e04e92bc"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "88d5de9df2c70534264b74b9caaae40783b2fb49acdda99ede50ade21cc88490"
    end
    on_intel do
      url "https://github.com/clm-cloud-solutions/kubebolt/releases/download/v#{version}/kubebolt-linux-amd64"
      sha256 "35a84ce76cbc1b8a4316a0db92a0e7025c462a5297bff4fe19df1b2da3c4394a"
    end
  end
