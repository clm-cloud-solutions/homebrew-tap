...
#   3. Replaces 2.0.3 / __SHA_*__ placeholders
...
class Kubebolt < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "59d3613e12414f29a28834fe375a6442f5ff3f42a0e66966fd437699a1d16c2e"
    end
    on_intel do
      url "https://github.com/clm-cloud-solutions/kubebolt/releases/download/v#{version}/kubebolt-darwin-amd64"
      sha256 "085513cec9515a05d3c3a0160043a745a392f2d8dd335f706aee87f33029c221"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "20e906bb4c2d98c41684418bad029be3ed9469f6545ff669d254750d6b941c4d"
    end
    on_intel do
      url "https://github.com/clm-cloud-solutions/kubebolt/releases/download/v#{version}/kubebolt-linux-amd64"
      sha256 "28fe57fbf97593c4678541a5c6b502d035e61636310def4a7960a2ddc368ef18"
    end
  end
