...
#   3. Replaces 2.0.4 / __SHA_*__ placeholders
...
class Kubebolt < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "63001058a412343bd62ede330b65ed51a88c25164bdb0353da4d02460a517e44"
    end
    on_intel do
      url "https://github.com/clm-cloud-solutions/kubebolt/releases/download/v#{version}/kubebolt-darwin-amd64"
      sha256 "576124ff49238975c91daa50eeb9730e231237cd6f86ce0a4b07d43fa5243296"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "16061068a05ca050becc0e7b45535109a25082983902541c628fecf7fbdddaf3"
    end
    on_intel do
      url "https://github.com/clm-cloud-solutions/kubebolt/releases/download/v#{version}/kubebolt-linux-amd64"
      sha256 "668ecd6a70e08250448c492ec83fb8b975beb8bd86790f4dd23eef17feecd6ce"
    end
  end
